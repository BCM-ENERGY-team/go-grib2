...
```bash
go get -u github.com/BCM-team/go-grib2
```
...
- [file-grib2csv](https://github.com/BCM-team/go-grib2/tree/master/cmd/examples/file-grib2csv) - export GRIB2 file to CSV
- [http-grib2csv](https://github.com/BCM-team/go-grib2/tree/master/cmd/examples/http-grib2csv) - export `nomads.ncep.noaa.gov` HTTP response to CSV
